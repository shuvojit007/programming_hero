...
public class Blanks_  extends RealmObject implements Parcelable {
    ...
    public Blanks_(Integer v1, Integer v2, String soln, String tf1, String tt1, String tt2, String tf2, String output, String op) {
        this.v1 = v1;
        this.v2 = v2;
        this.soln = soln;
        this.tf1 = tf1;
    ...
    public static final Parcelable.Creator<Blanks_> CREATOR = new Parcelable.Creator<Blanks_>() {
        @Override
        public Blanks_ createFromParcel(Parcel source) {
            return new Blanks_(source);
        }

        @Override
        public Blanks_[] newArray(int size) {
            return new Blanks_[size];
        }
    };
}
